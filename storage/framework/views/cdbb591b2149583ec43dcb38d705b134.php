<?php $__env->startSection('title', 'Staff & Tenaga Kependidikan - ' . ($profil->nama_sekolah ?? 'Sekolah')); ?>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-lg p-6 sticky top-24">
                        ...
                        <nav class="space-y-2">
                            ...
                            <a href="<?php echo e(route('profil.staff')); ?>" class="block px-4 py-2 bg-blue-600 text-white rounded">
                            ...
                            <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    ...
                                    <div class="aspect-w-3 aspect-h-4 bg-gray-200">
                                        <?php if($item->foto): ?>
                                            <img src="<?php echo e(Storage::url($item->foto)); ?>" alt="<?php echo e($item->nama); ?>"
                                    ...
                                    <!-- Info -->
                                    <div class="p-6">
                                        <h3 class="text-xl font-bold text-gray-900 mb-1"><?php echo e($item->nama); ?></h3>
                                        <p class="text-blue-600 font-semibold mb-2"><?php echo e($item->jabatan); ?></p>

                                        <?php if($item->nip): ?>
                                            <p class="text-sm text-gray-500 mb-2">NIP: <?php echo e($item->nip); ?></p>
                                        <?php endif; ?>

                                        <?php if($item->pendidikan): ?>
                                        ...
                                        <?php if($item->email): ?>
                                            <div class="flex items-center text-sm text-gray-600 mb-2">
                                                ...
                                                <a href="mailto:<?php echo e($item->email); ?>"
                                                    class="text-blue-600 hover:underline"><?php echo e($item->email); ?></a>
                                            </div>
                                        <?php endif; ?>
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-blue-700">
                                    <p>Staff dan tenaga kependidikan kami berdedikasi penuh untuk mendukung proses
                                        pembelajaran di <?php echo e($profil->nama_sekolah ?? 'sekolah kami'); ?>. Semua tenaga
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-sekolah\resources\views/profil/staff.blade.php ENDPATH**/ ?>