<?php $__env->startSection('title', 'Download - ' . ($profil->nama_sekolah ?? 'Sekolah')); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-8">
                <div class="flex flex-wrap gap-2">
                    ...
                    <?php echo e(!request('kategori') ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>">
                        Semua
                    </a>
                    <a href="<?php echo e(route('downloads.index', ['kategori' => 'formulir'])); ?>"
                        class="px-4 py-2 rounded-lg font-medium transition duration-200
                    <?php echo e(request('kategori') == 'formulir' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>">
                        Formulir
                    </a>
                    <a href="<?php echo e(route('downloads.index', ['kategori' => 'dokumen'])); ?>"
                        class="px-4 py-2 rounded-lg font-medium transition duration-200
                    <?php echo e(request('kategori') == 'dokumen' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>">
                        Dokumen
                    </a>
                    <a href="<?php echo e(route('downloads.index', ['kategori' => 'silabus'])); ?>"
                        class="px-4 py-2 rounded-lg font-medium transition duration-200
                    <?php echo e(request('kategori') == 'silabus' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>">
                        Silabus
                    </a>
                    <a href="<?php echo e(route('downloads.index', ['kategori' => 'panduan'])); ?>"
                        class="px-4 py-2 rounded-lg font-medium transition duration-200
                    <?php echo e(request('kategori') == 'panduan' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>">
                        Panduan
                    </a>
                </div>
            </div>
            ...
            <?php if($downloads->count() > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $downloads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition duration-200 overflow-hidden">
                            ...
                            <div class="p-6">
                                <div class="mb-3">
                                    ...
                                    <?php echo e($item->kategori == 'formulir'
                                ...
                                <h3 class="text-lg font-bold text-gray-900 mb-2 line-clamp-2"><?php echo e($item->judul); ?></h3>
                                ...
                                <a href="<?php echo e(route('downloads.download', $item->id)); ?>"
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-sekolah\resources\views/downloads/index.blade.php ENDPATH**/ ?>