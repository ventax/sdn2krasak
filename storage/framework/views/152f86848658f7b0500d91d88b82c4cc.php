            ...
            <div class="flex justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    <a href="<?php echo e(route('home')); ?>"
                        class="px-4 py-2 rounded-md text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition <?php echo e(request()->routeIs('home') ? 'bg-blue-50 text-blue-600 font-semibold' : ''); ?>">
                        Beranda
                    </a>
                    ...
                    <a href="<?php echo e(route('berita.index')); ?>"
                        class="px-4 py-2 rounded-md text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition <?php echo e(request()->routeIs('berita.*') ? 'bg-blue-50 text-blue-600 font-semibold' : ''); ?>">
                        Berita
                    </a>
                    <a href="<?php echo e(route('galeri.index')); ?>"
                        class="px-4 py-2 rounded-md text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition <?php echo e(request()->routeIs('galeri.*') ? 'bg-blue-50 text-blue-600 font-semibold' : ''); ?>">
                        Galeri
                    </a>
                    <a href="<?php echo e(route('prestasi.index')); ?>"
                        class="px-4 py-2 rounded-md text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition <?php echo e(request()->routeIs('prestasi.*') ? 'bg-blue-50 text-blue-600 font-semibold' : ''); ?>">
                        Prestasi
                    </a>
                    <a href="<?php echo e(route('kontak.index')); ?>"
                        class="px-4 py-2 rounded-md text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition <?php echo e(request()->routeIs('kontak.*') ? 'bg-blue-50 text-blue-600 font-semibold' : ''); ?>">
                        Kontak
                    </a>
    ...
    <footer class="bg-gray-900 text-white mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="<?php echo e(route('ppdb.cek')); ?>" class="block text-gray-400 hover:text-white transition">Cek
                            Status PPDB</a>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> Sekolah Gratis. Semua Hak Dilindungi.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\laragon\www\website-sekolah\resources\views/layouts/public.blade.php ENDPATH**/ ?>