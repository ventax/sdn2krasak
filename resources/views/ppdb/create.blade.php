...
@section('title', 'Pendaftaran PPDB - ' . ($profil->nama_sekolah ?? 'Sekolah'))
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                <div class="text-center">
                    ...
                    <p class="text-gray-600">{{ $profil->nama_sekolah ?? 'Sekolah Gratis' }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">No. HP Orang Tua <span
                                    class="text-red-500">*</span></label>
                            <input type="tel" name="no_hp_ortu" value="{{ old('no_hp_ortu') }}" required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                    </div>
                </div>
