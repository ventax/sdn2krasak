...
@section('title', 'Sejarah Sekolah - ' . ($profil->nama_sekolah ?? 'Sekolah'))
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-lg p-6 sticky top-24">
                        ...
                        <nav class="space-y-2">
                            ...
                            <a href="{{ route('profil.sejarah') }}" class="block px-4 py-2 bg-blue-600 text-white rounded">
                                Sejarah
                            </a>
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 p-8 text-white">
                            ...
                            <p class="text-blue-100">Perjalanan {{ $profil->nama_sekolah ?? 'Sekolah' }}</p>
                        </div>
                                ...
                                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                                    @if ($profil->tahun_berdiri)
                                        <div class="bg-blue-50 rounded-lg p-6 text-center">
                                            <div class="text-4xl font-bold text-blue-600 mb-2">{{ $profil->tahun_berdiri }}
                                            </div>
                                    ...
                                    @if ($profil->akreditasi)
                                        <div class="bg-green-50 rounded-lg p-6 text-center">
                                            <div class="text-4xl font-bold text-green-600 mb-2">{{ $profil->akreditasi }}
                                            </div>
                                    ...
                                    <div class="space-y-8">
                                        ...
                                        <div class="relative pl-0 md:pl-12">
                                            ...
                                            <div
                                                ...
                                                <div class="text-sm font-semibold text-blue-600 mb-1">{{ date('Y') }}
                                                </div>
                                        ...
                                        @if ($profil && $profil->tahun_berdiri)
                                            <div class="relative pl-0 md:pl-12">
                                                <div
                                                ...
                                                <div
                                                    ...
                                                    <p class="text-gray-600">{{ $profil->nama_sekolah }} resmi didirikan
