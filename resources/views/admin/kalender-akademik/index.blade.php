...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-2xl font-bold text-gray-800">Kelola Kalender Akademik</h2>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($kalender as $item)
                    <tr>
                        <td class="px-6 py-4 font-semibold">{{ $item->kegiatan }}</td>
                        ...
                        <td class="px-6 py-4 flex space-x-2">
                            ...
                            <form action="{{ route('admin.kalender-akademik.destroy', $item) }}" method="POST"
