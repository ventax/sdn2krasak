...
@section('title', $profil->nama_sekolah ?? 'Sekolah Gratis Berkualitas')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <h1 class="text-4xl lg:text-6xl font-extrabold mb-6 leading-tight">
                        {{ $profil->nama_sekolah ?? 'Sekolah Gratis Berkualitas' }}
                    </h1>
                ...
                <div class="hidden lg:block">
                    @if ($profil && $profil->foto_sekolah)
                        <img src="{{ Storage::url($profil->foto_sekolah) }}" alt="Foto Sekolah"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center">
                    <div class="text-4xl lg:text-5xl font-bold text-blue-600 mb-2">{{ $stats['total_guru'] ?? 0 }}+</div>
                    <div class="text-gray-600 font-medium">Guru Profesional</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl lg:text-5xl font-bold text-green-600 mb-2">{{ $stats['total_siswa'] ?? 0 }}+</div>
                    <div class="text-gray-600 font-medium">Siswa Aktif</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl lg:text-5xl font-bold text-purple-600 mb-2">{{ $stats['total_prestasi'] ?? 0 }}+
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition duration-200">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Akreditasi {{ $profil->akreditasi ?? 'A' }}</h3>
                        ...
                        <article
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-gray-600 mb-4 line-clamp-3">
                                    {{ Str::limit(strip_tags($item->konten), 100) }}</p>
                                <a href="{{ route('berita.show', $item->slug) }}"
                    ...
                    @foreach ($prestasi->take(3) as $item)
                        <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition duration-200">
                            ...
                            <div class="flex items-start mb-4">
                                ...
                                <div class="flex-1">
                                    <h3 class="text-lg font-bold text-gray-900 mb-2">{{ $item->nama_lomba }}</h3>
                                    <p class="text-sm font-semibold text-blue-600 mb-1">{{ $item->juara }}</p>
                                    @if ($item->nama_siswa)
                                        <p class="text-sm text-gray-600 mb-1">{{ $item->nama_siswa }}</p>
                                    @endif
                    ...
                    @foreach ($galeri->take(8) as $item)
                        <a href="{{ route('galeri.show', $item->id) }}"
                            ...
                            <div
                                ...
                                <span
                                    class="text-white opacity-0 group-hover:opacity-100 transition duration-200 font-semibold">{{ $item->judul }}</span>
                            </div>
                        </a>
                    @endforeach
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="mt-8 text-white text-sm">
                    <p>📞 {{ $profil->telepon ?? '(021) xxx-xxxx' }} | ✉️ {{ $profil->email ?? 'info@sekolah.sch.id' }}
                    </p>
                </div>
            </div>
        </div>
